#include <windows.h>
#include "typoPresser.h"

namespace MACROS {
void typoPresser::Press(short int i) {
  switch (i) {
    case 1:
...
void typoPresser::UnPress(short int i) {
  if (pressed[i - 1]) {
    switch (i) {
      case 1:
...
void typoPresser::Copy() {
  Press(12);
  Press(53);
  UnPress(12);
  UnPress(53);
}
void typoPresser::Paste() {
  Press(12);
  Press(72);
  UnPress(12);
  UnPress(72);
}
void typoPresser::Undo() {
  Press(12);
  Press(76);
  UnPress(12);
  UnPress(76);
}
void typoPresser::Select() {
  Press(12);
  Press(51);
  UnPress(12);
  UnPress(51);
}
void typoPresser::Scroll(int amount) {
  mouse_event(MOUSEEVENTF_WHEEL, 0, 0, amount, 0);
}
void typoPresser::CursorPosition(int dx, int dy) {
  SetCursorPos(dx, dy);
}
